...
- Поддержка **OpenAI (GPT)**, **Anthropic (Claude)**, **DeepSeek**, **Qwen** и любых OpenAI-совместимых API
- Переключение модели per-chat командой `/model provider/model-name`
- Контекстный диалог с историей на уровне чата
